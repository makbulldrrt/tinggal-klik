<x-app-layout>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box}
        .lp-wrap{max-width:1100px;margin:32px auto;padding:0 24px;font-family:Inter,system-ui,sans-serif;color:#1d1d1f;font-size:17px}
        ...
        .btn-primary{display:inline-flex;align-items:center;gap:7px;background:#0066cc;color:#fff;font-size:15px;font-weight:500;padding:9px 22px;border-radius:9999px;text-decoration:none;border:none;cursor:pointer;transition:background .15s;font-family:inherit}
        .btn-primary:hover{background:#0055aa}
        .btn-edit{display:inline-flex;align-items:center;background:transparent;color:#0066cc;font-size:14px;font-weight:500;padding:6px 14px;border-radius:9999px;border:1px solid #0066cc;text-decoration:none;transition:background .15s,color .15s}
        .btn-edit:hover{background:#0066cc;color:#fff}
        .btn-delete{display:inline-flex;align-items:center;background:transparent;color:#c0392b;font-size:14px;font-weight:500;padding:6px 14px;border-radius:9999px;border:1px solid #e74c3c;cursor:pointer;font-family:inherit;transition:background .15s,color .15s}
        ...
        .badge{display:inline-block;padding:3px 12px;border-radius:9999px;font-size:12px;font-weight:600;letter-spacing:.2px}
        .badge-tersedia{background:#e8f9ef;color:#1a7f45}
        .badge-tidak{background:#fff3e0;color:#c25f00}
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge {{ $item->status === 'tersedia' ? 'badge-tersedia' : 'badge-tidak' }}">
                                {{ ucfirst($item->status) }}
                            </span>
                        </td>
                        <td>
